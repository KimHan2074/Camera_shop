			...
			<div className="container">
				...
				<div className="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul className="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li><a className="nav-link" href="#"><img src="splitLayoutTest/images/user.svg"/></a></li>
						<li><a className="nav-link" href="cart.html"><img src="splitLayoutTest/images/cart.svg"/></a></li>
                        {/* Tất cả đều phải có thẻ đóng */}
					</ul>
				</div>
			</div>	
		</nav>
